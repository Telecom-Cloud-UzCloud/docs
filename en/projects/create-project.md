...
This guide provides step-by-step instructions for creating a project in UzCloud, adding users, and configuring account limits and quotas for the project.
...
![New Project Details](../../images/create-new-project.png)
...
![Project Resources](../../images/create-new-project-resources.png)
...
![Add User](../../images/create-new-project-add-user.png)
...
![Account Limits](../../images/create-new-project-account-limit.png)
...
![Increase Quota](../../images/create-new-project-account-limit-increase.png)

By following this guide, you can effectively create and manage projects within UzCloud, ensuring seamless collaboration and optimized resource allocation.
